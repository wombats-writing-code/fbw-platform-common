...
return(
_react2['default'].createElement('li',{className:'course',key:'course_'+course.Id,onClick:function(){function onClick(){return _this2.props.onSelectCourse(course);}return onClick;}()},
_react2['default'].createElement('p',null,course.Name)));
