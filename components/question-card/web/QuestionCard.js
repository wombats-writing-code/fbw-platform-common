...
};_this.state={selectedChoiceId:null,isExpanded:props.isExpanded};return _this;}_createClass(QuestionCard,[{key:'componentDidMount',value:function(){function componentDidMount(){if(window.MathJax){MathJax.Hub.Queue(["Typeset",MathJax.Hub]);}}return componentDidMount;}()},{key:'componentDidUpdate',value:function(){function componentDidUpdate(){if(window.MathJax){MathJax.Hub.Queue(["Typeset",MathJax.Hub]);}}return componentDidUpdate;}()},{key:'render',value:function(){function render(){var _this2=this;var submitButtonText=void 0;if(!this.props.isInProgressSubmitChoice){submitButtonText='Submit';}else{submitButtonText='Working...';}var submitButton=void 0;if(this.props.isSubmitEnabled!==false){if(!this.props.question.responded&&!this.state.selectedChoiceId){submitButton=_react2['default'].createElement('button',{disabled:true,onClick:function(){function onClick(){return _this2._onSubmitChoice(_this2.state.selectedChoiceId,_this2.props.question);}return onClick;}(),className:'submit-button is-disabled',__source:{fileName:_jsxFileName,lineNumber:53}},submitButtonText);}else if(!this.props.question.responded&&!this.props.isInProgressSubmitChoice){submitButton=_react2['default'].createElement('button',{onClick:function(){function onClick(){return _this2._onSubmitChoice(_this2.state.selectedChoiceId,_this2.props.question);}return onClick;}(),className:'submit-button',ref:function(){function ref(btn){return _this2.activeSubmitButton=btn;}return ref;}(),__source:{fileName:_jsxFileName,lineNumber:60}},submitButtonText);}}var inProgressIndicator=void 0;if(this.props.isInProgressShowAnswer){if((0,_mission.isTarget)(this.props.question)){inProgressIndicator=_react2['default'].createElement('div',{style:styles.inProgressIndicator,__source:{fileName:_jsxFileName,lineNumber:73}},_react2['default'].createElement('p',{style:_lodash2['default'].assign({},styles.inProgressIndicatorText,this._getTextProgressStyles()),onLayout:this._onProgressTextLayout,__source:{fileName:_jsxFileName,lineNumber:74}},'Fetching the answer...you can no longer get points on this Target.'));}else{inProgressIndicator=_react2['default'].createElement('div',{style:styles.inProgressIndicator,__source:{fileName:_jsxFileName,lineNumber:81}},_react2['default'].createElement('p',{style:_lodash2['default'].assign({},styles.inProgressIndicatorText,this._getTextProgressStyles()),__source:{fileName:_jsxFileName,lineNumber:82}},'Fetching the answer...'));}}var questionTypeIcon=void 0;if((0,_mission.isTarget)(this.props.question)){if(this.props.question.responded&&this.props.question.response.isCorrect){questionTypeIcon=_react2['default'].createElement('img',{alt:'Goal question',className:'question-type-icon',src:require('../../../assets/target-icon--correct@2x.png'),__source:{fileName:_jsxFileName,lineNumber:93}});}else if(this.props.question.responded&&!this.props.question.response.isCorrect){questionTypeIcon=_react2['default'].createElement('img',{alt:'Goal question',className:'question-type-icon',src:require('../../../assets/target-icon--incorrect@2x.png'),__source:{fileName:_jsxFileName,lineNumber:99}});}else{questionTypeIcon=_react2['default'].createElement('img',{alt:'Goal question',className:'question-type-icon',src:require('../../../assets/target-icon@2x.png'),__source:{fileName:_jsxFileName,lineNumber:105}});}}else{if(this.props.question.responded&&this.props.question.response.isCorrect){questionTypeIcon=_react2['default'].createElement('img',{alt:'Review question',className:'question-type-icon',src:require('../../../assets/waypoint-icon--correct@2x.png'),__source:{fileName:_jsxFileName,lineNumber:112}});}else if(this.props.question.responded&&!this.props.question.response.isCorrect){questionTypeIcon=_react2['default'].createElement('img',{alt:'Review question',className:'question-type-icon',src:require('../../../assets/waypoint-icon--incorrect@2x.png'),__source:{fileName:_jsxFileName,lineNumber:118}});}else{questionTypeIcon=_react2['default'].createElement('img',{alt:'Review question',className:'question-type-icon',src:require('../../../assets/waypoint-icon@2x.png'),__source:{fileName:_jsxFileName,lineNumber:124}});}}var solutionStateText=this.props.question.responded&&this.props.question.response.isCorrect?'Correct!':'Incorrect...';var solution=this.props.question.responded&&this.state.isExpanded?_react2['default'].createElement('div',{role:'group',className:'question-card__solution',tabIndex:-1,ref:function(){function ref(sol){_this2.solution=sol;}return ref;}(),__source:{fileName:_jsxFileName,lineNumber:136}},_react2['default'].createElement('p',{className:'bold uppercase',__source:{fileName:_jsxFileName,lineNumber:141}},solutionStateText),_react2['default'].createElement('p',{className:'bold uppercase',__source:{fileName:_jsxFileName,lineNumber:142}},'Solution'),_react2['default'].createElement('div',{className:'',dangerouslySetInnerHTML:{__html:this.props.question.text},__source:{fileName:_jsxFileName,lineNumber:143}}),_react2['default'].createElement('div',{className:'question-card__question-border',__source:{fileName:_jsxFileName,lineNumber:146}}),_react2['default'].createElement('div',{className:'',dangerouslySetInnerHTML:{__html:this.props.question.feedback},__source:{fileName:_jsxFileName,lineNumber:147}})):null;var choices=this.state.isExpanded?_react2['default'].createElement(_Choices2['default'],{onSelectChoice:function(){function onSelectChoice(choiceId){return _this2.setState({selectedChoiceId:choiceId});}return onSelectChoice;}(),selectedChoiceId:this.state.selectedChoiceId,choices:this.props.question.choices,responseId:this.props.question.responded?this.props.question.response.choice.id:null,isResponseCorrect:this.props.question.responded?this.props.question.response.isCorrect:null,__source:{fileName:_jsxFileName,lineNumber:153}}):null;return _react2['default'].createElement('div',{role:'group',className:'question-card clearfix',__source:{fileName:_jsxFileName,lineNumber:160}},_react2['default'].createElement(_QuestionHeader2['default'],{questionTypeIcon:questionTypeIcon,headerText:this.props.outcome?this.props.outcome.displayName:'',onShowAnswer:function(){function onShowAnswer(){return _this2._onShowAnswer(_this2.props.question);}return onShowAnswer;}(),isExpanded:this.state.isExpanded,isExpandable:this.props.question.responded||this.props.isExpandable,onToggleExpand:function(){function onToggleExpand(){return _this2.setState({isExpanded:!_this2.state.isExpanded});}return onToggleExpand;}(),__source:{fileName:_jsxFileName,lineNumber:163}}),inProgressIndicator,_react2['default'].createElement('fieldset',{className:'question-card__body clearfix',__source:{fileName:_jsxFileName,lineNumber:173}},_react2['default'].createElement('legend',{dangerouslySetInnerHTML:{__html:this.props.question.text},__source:{fileName:_jsxFileName,lineNumber:174}}),choices),solution,submitButton);}return render;}()}]);return QuestionCard;}(_react.Component);
