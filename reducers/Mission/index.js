Object.defineProperty(exports,"__esModule",{value:true});exports.missionConfig=undefined;exports['default']=
...
var newCurrentMission=_lodash2['default'].find(state.missions,{id:followsFromMissions[0]});
...
leadsToMissions:_lodash2['default'].compact(_lodash2['default'].uniq(_lodash2['default'].concat(mission.leadsToMissions,newMissionIds)))});

}

return mission;
}),
currentMission:_lodash2['default'].assign({},newCurrentMission,{
leadsToMissions:newCurrentMission?_lodash2['default'].compact(_lodash2['default'].uniq(_lodash2['default'].concat(newCurrentMission.leadsToMissions,newMissionIds))):newMissionIds})});



case _deleteMission.RECEIVE_DELETE_MISSION:
var m=state.currentMission?_lodash2['default'].assign({},state.currentMission,{
leadsToMissions:_lodash2['default'].without(state.currentMission.leadsToMissions,action.mission.id)}):
null;

return _lodash2['default'].assign({},state,{
missions:_lodash2['default'].compact(_lodash2['default'].map(state.missions,function(m){
if(m.id!==action.mission.id){
return _lodash2['default'].assign({},m,{
leadsToMissions:_lodash2['default'].without(m.leadsToMissions,action.mission.id)});
...
var mission=_lodash2['default'].assign({},action.mission,{
